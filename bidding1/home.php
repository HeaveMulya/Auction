                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            $query = "SELECT * FROM products WHERE unix_timestamp(bid_end_datetime) >= $currentTimestamp  $where ORDER BY name ASC";
                             ...
                             <div class="col-sm-4">
                                 <div class="card">
                                    <div class="float-right align-top bid-tag">
                                         <span class="badge badge-pill badge-success text-white"><i class="fa fa-tag"></i> <?php echo number_format($row['start_bid']) ?></span>
                                     </div>
                                     ...
                                     <div class="card-body prod-item">
                                        ...
                                        <button class="btn btn-success btn-sm view_prod" type="button" data-id="<?php echo $row['id'] ?>"> View</button>
                                     </div>
                                 </div>
                             </div>
                            <?php endwhile; ?>
